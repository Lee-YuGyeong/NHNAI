...
게임은 **첫 격리(처형)가 일어나는 그 자리에서 종료된다** — 의심도 100% 에 닿은 좌석은 즉시
격리되고, 그 한 명으로 판이 닫힌다. 격리된 것이 **AI 면 사람 승리**, **사람이나 AI 설계자면
AI 승리**다(격리된 설계자 본인은 진다). 아무도 격리되지 않은 채 세 시험과 마지막 대화까지 다
지나가도 **AI 승리** — 사람은 시간 안에 찾아내야 한다.

격리 목표(⌊총원 ÷ 2⌋, `roles.quotaFor`)는 와이어(`quota`)에 남아 있을 뿐 판을 끝내는 문턱이
아니다. 2026-09-05 이전에는 격리 수가 그 목표에 닿아야 끝났다.
...
| 카드 | 무엇 |
|---|---|
| **답변 강제권** | 상대는 내 다음 질문에 **15초 안에** 진실만 답해야 한다. 관리 AI가 그 답을 기록과 대조해 — 거짓이면 +25, 교묘히 피하면 +12, 진실이면 −10. 15초가 지나도 답이 없으면 무응답 +25 |
| **지목권** | 겨눈 상대의 의심도를 +20 |
| **진정권** | 내 의심도를 −20 |
