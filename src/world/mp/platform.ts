 ...
 * 대신 손을 떼면 줄일 수는 있다). 체공은 몸의 점프 속도가 정한다(mp/bodies.ts): fit 은 걸어 뛰면 2.36m 로 한 칸(2m)을
 * 넘고 달려 뛰면 4.71m(두 칸 4m, 발판 가장자리 4.8 안), 비만은 걸어 1.94m(발판 반지름 0.8m 라 다음 발판 앞쪽에 닿는다)·달려 2.91m 다.
