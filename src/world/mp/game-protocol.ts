...
export const SUSPICION = {
   ...
   *
   * 압력이 1.0 인 전반에는 아무것도 안 걸린다 (제일 큰 걸음이 읽기 16) — 전반의 동작은 한 자도 안 바뀐다.
 ...
 * 겨눔(pointing)은 토론이 바뀌어도 안 지워지므로 2차 토론부터는 지목(12)도 동조(8)도 다시 안 열리고,
 * 몰이 상한 12 도 2차 안에 소진된다 — 남는 것은 되풀이 +3 뿐이다. 셋이 한 사람을 계속 몰아도
