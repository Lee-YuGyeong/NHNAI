...
export const ASSETS = {
  ...
  /*
   * 무너지는 타워 생존(features/trial/games/tower, 2026-09-05)은 GLB 부품이 없다 — 발판 · 격자 기둥이 전부 코드 기하 + 힉스필드 텍스처
   * (public/textures/tower/)다. Tripo Studio 로 뽑았던 격자 기둥(tower_pylon)은 텍스처가 번져 걷었다 (TowerStage 머리말). HUD 시안은 UX Pilot(page q6v38m6GZMYLa7rrThVk)
   */
