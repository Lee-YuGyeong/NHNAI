 ...
 * 1명"). 나머지 둘은 여전히 안 적는다(×?) — 설계자 수는 인원이 정하고(roles.designerCount:
 * 3~5명→1 · 6~8명→2, 2026-09-05 사용자), 사람 수는 방마다 다르다. 감추는 것은 이제 수가
 * 아니라 **누구인가**다. 첫 화면에 적힌 숫자가 방에 들어가서
...
const STEPS = [
  ...
  },
  {
    ...
    body: `대화 ${GAME_DISCUSSION_MS / 1000}초와 시험 ${GAME_TEST_MS / 1000}초가 번갈아 ${GAME_TEST_COUNT}번 — 낙하 생존 · 움직이는 발판 · 회전 원판 · 무게 중심 다리 · 무너지는 타워 가운데 셋이 판마다 무작위로 뽑힌다. 숨는 것은 조건뿐이다: ${TRIAL_PHASE_MS / 1000}초 지점에서 말없이 한 번 바뀐다.`,
  },
