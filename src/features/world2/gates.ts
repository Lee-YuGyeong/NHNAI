 ...
 * 사람이 죽는 판정(즉결 · bad)이 여기 있으므로 **모델을 안 부른다**: 재료(사실 대조 · 표식 · 조각)가 이미 다 있어서 모델이 할 일이 없다.
 *
...
/**
 * 식별번호 대조. 재료는 셋 — 사실(matchUnit) · 표식(어투 흔들림 · 앞말과 어긋난 숫자) · 명판을 읽었나(known).
 *   맞다 · 표식 없음      ok
 *   맞다 · 표식 있음      okMarked (escort)
